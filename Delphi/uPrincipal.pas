...
begin
  ...
  pnlPaciente.Caption := ' Pacientes atendidos: 0      Pacientes não atendidos: 1';
  ...
  btnHistoricoPaciente.Caption := ' Histórico                ' + #13 + 'do paciente            ';
  Panel16.Color := RGB(0, 149, 213);
  btnHistoricoPaciente.Font.Color := clWhite;

  btnhistoricodeLaudos.Caption := ' Histórico              ' + #13 + 'de laudos            ';
  ...
  btncancelarFinalizacao.Caption := ' Cancelar           ' + #13 + 'finalização            ';
